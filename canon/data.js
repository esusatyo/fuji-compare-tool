...
const BRAND_CONFIG = {
  ...
  cameras: {
    ...
    heroSubtitle: 'Compare up to 4 EOS R cameras side-by-side across the full lineup',
    headerTitle:  'Canon',
...
const CAMERAS = {
  ...
  'eos-r50': {
    ...
    asin:'B0BTTVH7VF',
    prices:{USD:679,AUD:1099,EUR:799,GBP:699,JPY:114000,CAD:899,SGD:1099},
  ...
  'eos-r100': {
    ...
    asin:'B0C5PM5YH6',
    prices:{USD:479,AUD:699,EUR:599,GBP:399,JPY:75000,CAD:599,SGD:699},
    priceSource: { url:'https://www.usa.canon.com/shop/p/eos-r100', tier:'T1', note:'USD $479.99 body-only, official Canon USA store listing. Fix 2026-09-25: prices.USD was still $429, never actually updated to match this citation\'s own $479.99 conclusion.', date:'2026-08-09' },
  ...
  'eos-r6-ii': {
    ...
    priceSource: { url:'https://www.cpricewatch.com/product/07756/Canon-EOS-R6-Mark-II-price.html', tier:'T3', note:'USD $2,099 confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM (down from $2,499, likely repositioned below the newer R6 Mark III); usa.canon.com geo-blocked. Fix 2026-09-25: prices.USD was still $1,999, never actually updated to match this citation\'s own $2,099 conclusion.', date:'2026-08-22' },
    sensorMP:24.2, sensorType:'Full-frame BSI CMOS', processor:'DIGIC X',
  ...
  'eos-r7': {
    ...
    asin:'B0B27KKNZV',
    prices:{USD:1549,AUD:2299,EUR:1699,GBP:1349,JPY:210000,CAD:1899,SGD:2199},
  ...
  'eos-r10': {
    ...
    priceSource: { url:'https://www.cpricewatch.com/product/07650/Canon-EOS-R10-price.html', tier:'T3', note:'USD $1,099 confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM (up from $979 launch); usa.canon.com geo-blocked. Fix 2026-09-25: prices.USD was still $999, never actually updated to match this citation\'s own $1,099 conclusion.', date:'2026-08-22' },
    sensorMP:24.2, sensorType:'APS-C CMOS', processor:'DIGIC X',
  ...
  'eos-r5': {
    ...
    priceSource: { url:'https://www.bhphotovideo.com/c/product/1481058-REG/canon_3075c002_eos_r5_mirrorless.html', tier:'T3', note:'USD $2,999 (down from $3,899) confirmed flat/consistent across B&H and Adorama (regular/list $3,299 shown struck through on both) and matching Canon Store per cpricewatch aggregation; usa.canon.com geo-blocked. AUD $4,799 retained from the prior canon.com.au-confirmed figure (2026-08-09), now ratio-stale relative to the new USD — flagged for re-check. Fix 2026-09-25: prices.USD was still $2,799, never actually updated to match this citation\'s own $2,999 conclusion; user manually confirmed $2,999 is correct.', date:'2026-08-22' },
    sensorMP:45.0, sensorType:'Full-frame BSI CMOS', processor:'DIGIC X',
  ...
  'eos-r50v': {
    ...
    priceSource: { url:'https://www.cpricewatch.com/product/08391/Canon-EOS-R50-V-price.html', tier:'T3', note:'USD $619 confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM (down from $699 launch); usa.canon.com geo-blocked. Fix 2026-09-25: prices.USD was still $569, never actually updated to match this citation\'s own $619 conclusion.', date:'2026-08-22' },
    sensorMP:24.2, sensorType:'APS-C CMOS', processor:'DIGIC X',
    width:116.3, height:85.5, depth:68.8, weight:375, weatherSealed:false,
    lcdSize:'3.0"', lcdDots:1040, lcdType:'Vari-angle',
    evfType:null, evfDots:null, evfMag:null,
...
const LENSES = {
  ...
  'rf-20mm-f14-l-vcm': {
    ...
    prices:{USD:1799,AUD:2999,EUR:2199,GBP:1699,JPY:296000,CAD:2499,SGD:2799},
  ...
  'rf-28mm-f28-stm': {
    ...
    asin:'B0C66JMX91',
    prices:{USD:299,AUD:499,EUR:399,GBP:299,JPY:51000,CAD:399,SGD:499},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-50mm-f12-l-usm': {
    ...
    asin:'B07H4G9ZKW',
    prices:{USD:2499,AUD:4099,EUR:2999,GBP:2299,JPY:405000,CAD:3399,SGD:3799},
  ...
  'rf-50mm-f18-stm': {
    ...
    asin:'B08MFVH7SV',
    prices:{USD:199,AUD:299,EUR:299,GBP:199,JPY:34000,CAD:299,SGD:299},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-85mm-f12-l-usm': {
    ...
    asin:'B07RB7SHD7',
    prices:{USD:2999,AUD:4799,EUR:3599,GBP:2799,JPY:483000,CAD:3999,SGD:4499},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-85mm-f12-l-usm-ds': {
    ...
    asin:'B07Z5M2MDJ',
    prices:{USD:3299,AUD:5499,EUR:3899,GBP:3099,JPY:530000,CAD:4399,SGD:4899},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-24mm-f14-l-vcm': {
    ...
    asin:'B0DKZTZX3Q',
    prices:{USD:1499,AUD:2700,EUR:1799,GBP:1399,JPY:242000,CAD:1999,SGD:2199},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-35mm-f14-l-vcm': {
    ...
    asin:'B0D5ZJ2XJ9',
    prices:{USD:1549,AUD:2699,EUR:1799,GBP:1399,JPY:249000,CAD:2099,SGD:2299},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-800mm-f56-l-is-usm': {
    ...
    imageUrl:'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Canon_RF_800mm_f5.6L_IS_USM.jpg/500px-Canon_RF_800mm_f5.6L_IS_USM.jpg',
    imageCredit:{author:"Dinkun Chen", licence:"CC BY-SA 4.0", licenceUrl:"https://creativecommons.org/licenses/by-sa/4.0", source:"https://commons.wikimedia.org/wiki/File:Canon_RF_800mm_f5.6L_IS_USM.jpg"},
    asin:'B09TL8224F',
  ...
  'rf-16-28mm-f28-is-stm': {
    ...
    prices:{USD:999,AUD:1599,EUR:1199,GBP:899,JPY:164000,CAD:1399,SGD:1499},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-24-70mm-f28-l-is-usm': {
    ...
    asin:'B07WQ54BL8',
    prices:{USD:2399,AUD:3899,EUR:2899,GBP:2199,JPY:390000,CAD:3199,SGD:3599},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'rf-24-105mm-f28-l-is-usm-z': {
    ...
    asin:'B0CMDFX1G9',
    prices:{USD:3199,AUD:5399,EUR:3799,GBP:2999,JPY:515000,CAD:4299,SGD:4799},
    priceSource: { url:'https://www.cpricewatch.com/prices/', tier:'T3', note:'USD confirmed flat/consistent across B&H, Adorama, Canon Store, and PROCAM per cpricewatch aggregation (part of a broad RF-lens price wave observed across the lineup this run); usa.canon.com geo-blocked so aggregator used as the cross-dealer source', date:'2026-08-22' },
  ...
  'ttartisan-35mm-f14-apsc': {
    ...
    imageSource: { url:'https://ttartisan.store/products/aps-c-35mm-f1-4', tier:'T1', note:'official TTArtisan store page, barrel reads "TTARTISAN"; Canon RF is a selectable mount option (product page\'s own "Canon RF-mount / Application Model" section lists R7/R10/R50/R100 and RF full-frame bodies in APS-C crop mode). No mount-specific marking visible in the photo (front barrel is mount-agnostic for this manual lens), accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/aps-c-35mm-f1-4', tier:'T1', note:'spec table (focal/aperture/MFD/blades/filter/elements/weight — weight is a single published figure, not a range) and Mount selector confirming Canon RF', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/aps-c-35mm-f1-4', tier:'T1', note:'the page\'s "Size" row image renders a per-mount dimension diagram (E/X/EOS-M/M43 = 56x44mm, Z = 63x42mm, RF = 63x42mm, L = 60x43mm); length/diameter above are the RF column, read directly off the downloaded image', date:'2026-08-29' },
    ],
    asin:'B0BC3QMRK6',
    prices:{USD:80,AUD:99,EUR:99,GBP:99,JPY:10000,CAD:99,SGD:99},
  ...
  'ttartisan-23mm-f14-apsc': {
    ...
    elements:8, groups:6, blades:10, afType:'Manual',
    weatherSealed:false, ois:false, oisStops:null, year:2021, discontinued:false,
    imageUrl:'https://ttartisan.store/cdn/shop/files/23mmf1.4.jpg',
    imageSource: { url:'https://ttartisan.store/products/aps-c-23mm-f1-4-black', tier:'T1', note:'official TTArtisan store page, barrel reads "TTARTISAN"; Canon RF is a selectable Mount option (shown "Variant sold out or unavailable" — a stock-status flag, not evidence the SKU doesn\'t exist) and the page\'s "Canon RF-mount / Application Model" section lists R7/R10/R50/R100. No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/aps-c-23mm-f1-4-black', tier:'T1', note:'spec table and Mount selector confirming Canon RF; weight published as a range ("around 222~250g") — top of range used, consistent with this dataset\'s existing convention for TTArtisan cross-mount ranges (RF/L tend to be the heaviest variant), not independently re-measured for this specific lens', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/aps-c-23mm-f1-4-black', tier:'T1', note:'the "Size" row image gives per-mount L x diameter; RF column = 63x41mm, read directly off the downloaded image', date:'2026-08-29' },
    ],
    asin:'B0BJ1PQGXH',
    prices:{USD:114,AUD:199,EUR:99,GBP:99,JPY:15000,CAD:99,SGD:199},
    productUrl:'https://ttartisan.store/products/aps-c-23mm-f1-4-black',
  },
  ...
  'ttartisan-10mm-f2-asph-apsc': {
    ...
    imageSource: { url:'https://ttartisan.store/products/102', tier:'T1', note:'official TTArtisan store page, barrel reads "TTARTISAN"; Canon RF is a selectable Mount option and the spec-table Mount field ("E / X / Z / M43 / RF") independently agrees. No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/102', tier:'T1', note:'spec table (filter is "72mm (external filter holder)" — a bulbous front with a screw-on holder accessory, recorded as filterThread:72 since it is a real accessory thread size) and Mount selector confirming Canon RF; weight published as a range ("around 333~345g") — top of range used per this dataset\'s existing convention', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/102', tier:'T1', note:'the "Size" row image gives per-mount L x diameter; RF column = 61x63mm, read directly off the downloaded image', date:'2026-08-29' },
      { url:'https://www.bhphotovideo.com/c/product/1801465-REG/ttartisan_c1020_b_rf_10mm_f_2_lens_canon.html', tier:'T3', note:'corroborates a Canon RF SKU (C1020-B-RF) exists at retail; not used for specs', date:'2026-08-29' },
    ],
    asin:'B0CPSVY71Q',
    prices:{USD:169,AUD:299,EUR:199,GBP:199,JPY:25000,CAD:199,SGD:199},
  ...
  'ttartisan-tilt-35mm-f14-apsc': {
    ...
    elements:7, groups:6, blades:10, afType:'Manual',
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_a0d57456-3563-4228-a0f8-276652425a13.jpg',
    imageSource: { url:'https://ttartisan.store/products/tilt-35mm-f1-4', tier:'T1', note:'official TTArtisan store page, barrel reads "TTArtisan" and "Tilt 35"; Canon RF is a selectable Mount option, corroborated by Canon Rumors\' own headline "TTArtisan Launches The RF 35mm f/1.4 Tilt Lens for APS-C". No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/tilt-35mm-f1-4', tier:'T1', note:'spec table and Mount selector confirming Canon RF; weight published as a range ("Around 341~350g") — top of range used per this dataset\'s existing convention', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/tilt-35mm-f1-4', tier:'T1', note:'the "Size" row image gives per-mount L x diameter; RF column = 66x61mm, read directly off the downloaded image', date:'2026-08-29' },
      { url:'https://petapixel.com/2025/05/09/ttartisans-new-tilt-35mm-f-1-4-lens-offers-creative-depth-of-field-control/', tier:'NEWS', note:'confirms May 9 2025 announcement across Sony E/Fuji X/Nikon Z/Canon RF/MFT together, supporting year:2025 for the RF entry', date:'2026-08-29' },
    ],
    asin:'B0F671MLJY',
    prices:{USD:169,AUD:299,EUR:199,GBP:199,JPY:26000,CAD:199,SGD:199},
  ...
  'ttartisan-tilt-shift-17mm-f4-asph': {
    ...
    imageUrl:'https://ttartisan.store/cdn/shop/files/SKU-E_64d0076e-1506-4c4f-8997-039c74ff7da7.jpg',
    imageSource: { url:'https://ttartisan.store/products/tilt-shift-17mm-f4-asph', tier:'T1', note:'official TTArtisan store page, barrel reads "TTArtisan" and "Tilt-Shift 17/4"; Canon RF is a selectable Mount option and a verified customer review on the page states "I am using this on several Canon RF mount cameras". No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/tilt-shift-17mm-f4-asph', tier:'T1', note:'spec table (filter "not support" -> filterThread:null) and full page text confirming real price $550.00 (a naive first-"$"-match on the page missed this and grabbed an unrelated $84 add-on-item figure); weight published as a narrow range ("Around 1051~1060g") — midpoint used', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/tilt-shift-17mm-f4-asph', tier:'T1', note:'the page has two separate "Size" images: one comparing Sony E vs Fuji GFX (the two mounts at original launch), a second comparing Z/L/RF (added later). The RF column in the second image (2225x787px) was illegible at native resolution through the standard viewer and was recovered by cropping+4x-upscaling the raw PNG with a small dependency-free decoder; gave RF = 88mm(L) x 113mm(diameter). Verified as the correct column by re-cropping a wider region including the visible "RF-Mount" text label', date:'2026-08-29' },
      { url:'https://www.newsshooter.com/2025/10/10/ttartisan-17mm-f4-tilt-shift/', tier:'NEWS', note:'confirms Oct 2025 launch was Sony E + Fuji GFX only', date:'2026-08-29' },
      { url:'https://nikonrumors.com/2026/03/08/ttartisan-announced-a-new-17mm-f-4-tilt-shift-lens-for-nikon-z-mount.aspx/', tier:'NEWS', note:'confirms Nikon Z / Canon RF / Leica L were added March 2026 -- this is the source for year:2026 on this RF-specific entry (the design itself first shipped 2025, but not in RF)', date:'2026-08-29' },
    ],
    asin:'B0GQH1NMNX',
    prices:{USD:550,AUD:899,EUR:599,GBP:499,JPY:86000,CAD:699,SGD:799},
    productUrl:'https://ttartisan.store/products/tilt-shift-17mm-f4-asph',
  },
  ...
  'ttartisan-14mm-f28-asph': {
    ...
    elements:13, groups:10, blades:8, afType:'Manual',
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    imageUrl:'https://ttartisan.store/cdn/shop/files/SKU-E-mount_c6170f6e-4fe7-4ab4-8397-b2f22396f84b.jpg',
    imageSource: { url:'https://ttartisan.store/products/14mm-f2-8', tier:'T1', note:'official TTArtisan store page, barrel reads "TTArtisan"; Canon RF is a selectable Mount option, corroborated by Photo Rumors\' headline naming E/Z/RF/L together at announcement. No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/14mm-f2-8', tier:'T1', note:'spec table (filter "77mm (external filter holder)") and full page text confirming real price $196.00; weight published as a narrow range ("Around 437~445g") — midpoint used', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/14mm-f2-8', tier:'T1', note:'the "Size" row image (899x421px) gives per-mount L x diameter directly; RF column = 65x75mm', date:'2026-08-29' },
      { url:'https://photorumors.com/2025/08/22/new-ttartisan-14mm-f-2-8-asph-full-frame-ultra-wide-angle-lens-for-e-z-rf-l-announced-196/', tier:'NEWS', note:'confirms Aug 22 2025 announcement covered E/Z/RF/L simultaneously, supporting year:2025 for the RF entry (not a later-added mount)', date:'2026-08-29' },
    ],
    asin:'B0FMF9BNG7',
    prices:{USD:196,AUD:299,EUR:199,GBP:199,JPY:30000,CAD:299,SGD:299},
    productUrl:'https://ttartisan.store/products/14mm-f2-8',
  },
  ...
  'ttartisan-100mm-f28-2x-macro': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2024, discontinued:false,
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_76422df3-5734-40e0-80f1-464e1eb289e0.jpg',
    imageSource: { url:'https://ttartisan.store/products/100mm-f2-8macro', tier:'T1', note:'official TTArtisan store page, barrel reads "TTArtisan 100mm F2.8 MACRO 2X"; Canon RF is a selectable Mount option, and the page\'s own "Canon RF-mount / Application Model" section lists a broad range of R-series bodies. No mount-specific marking visible in the photo, accepted since nothing in the image contradicts confirmed RF availability', date:'2026-08-29' },
    specSources: [
      { url:'https://ttartisan.store/products/100mm-f2-8macro', tier:'T1', note:'spec table (filter 67mm, MFD 0.25m, magnification 2:1, 14 elements/10 groups, 12 blades) and full page text confirming real price $339.00; weight published as a range ("Around 700~748g") — midpoint used', date:'2026-08-29' },
      { url:'https://ttartisan.store/products/100mm-f2-8macro', tier:'T1', note:'the "Size" row image (2500x600px, 8-mount comparison) gives per-mount L x diameter directly; RF column = 72x148mm', date:'2026-08-29' },
      { url:'https://petapixel.com/2024/07/12/ttartisan-simplifies-100mm-f-2-8-2x-macro-lens-by-removing-tilt-and-shift/', tier:'NEWS', note:'confirms this is a July 2024 simplified (non-tilt-shift) re-release sold across E/EF/F/GF/L/RF/X/Z, resolving a naming-hazard the archived round-1 research left open between this plain macro and a separate, later "Tilt-Shift 100mm F2.8 2X Macro" product at ttartisan.store/products/ts100 (not entered -- outside this batch\'s scope, wasn\'t on round 1\'s original 14-lens list); filter/MFD/weight-range/price here match round 1\'s ttartisan.com-scraped "TS-100-Macro" table exactly, confirming that slug refers to this plain macro, not the tilt-shift product', date:'2026-08-29' },
    ],
    asin:'B0DFPZDPC5',
    prices:{USD:339,AUD:499,EUR:399,GBP:299,JPY:51000,CAD:399,SGD:499},
    productUrl:'https://ttartisan.store/products/100mm-f2-8macro',
  },
...
const LENS_DROPDOWN_GROUPS = [
  ...
  { label: '── TTArtisan ──',          ids: ['ttartisan-50mm-f14-asph','ttartisan-tilt-50mm-f14','ttartisan-500mm-f63','ttartisan-50mm-f12','ttartisan-50mm-f095','ttartisan-35mm-f14-apsc','ttartisan-23mm-f14-apsc','ttartisan-10mm-f2-asph-apsc','ttartisan-tilt-35mm-f14-apsc','ttartisan-tilt-shift-17mm-f4-asph','ttartisan-14mm-f28-asph','ttartisan-100mm-f28-2x-macro'] },
