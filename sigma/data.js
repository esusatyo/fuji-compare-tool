...
const CAMERAS = {
  ...
  'sd-quattro': {
    ...
    // NOTE: 625g is Sigma's published body-only figure — every other brand on
    // the site stores weight WITH battery and card. Sigma publishes no
    // with-battery/CIPA weight for the sd Quattro pair and the BP-61's own
    // weight is not published either, so deriving one would be inventing a
    // number. Left as published; the Weight row understates these two bodies
