...
const CAMERAS = {
  ...
  'z6-iii': {
    ...
    asin:'B0D77SL8CY',
    prices:{USD:2200,AUD:3099,EUR:2299,GBP:1799,JPY:312000,CAD:2599,SGD:2899},
    priceSource: { url:'https://www.nikonusa.com/p/z6iii/1890/overview', tier:'T1', note:'"Starting at $2,199.95" body-only on nikonusa.com (Aug 2026); corrects the stale $2,000 figure previously stored here', date:'2026-08-23' },
  ...
  'zr': {
    ...
    asin:'B0FPXLG8X7',
    prices:{USD:2200,AUD:3499,EUR:2549,GBP:2099,JPY:363000,CAD:2999,SGD:3149},
    priceSource: { url:'https://www.nikonusa.com/p/zr/2043/overview', tier:'T1', note:'"Starting at $2,199.95" body-only on nikonusa.com (Aug 2026); rounds up from the previously stored $2,199', date:'2026-08-23' },
    sensorMP:24.5, sensorType:'Full-frame Partially-Stacked BSI CMOS', processor:'EXPEED 7',
