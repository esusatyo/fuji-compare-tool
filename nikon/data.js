...
const BRAND_CONFIG = {
  ...
  cameras: {
    ...
    heroSubtitle: 'Compare up to 4 Nikon Z cameras side-by-side across the full lineup',
    headerTitle:  'Nikon',
...
const CAMERAS = {
  ...
  'z9': {
    ...
    asin:'B09KHC4XCT',
    prices:{USD:5299,AUD:8299,EUR:6099,GBP:4799,JPY:827000,CAD:6899,SGD:7699},
    priceSource: { url:'https://www.nikonusa.com/p/z-9/1669/overview', tier:'T1', note:'"$5,299.95" body-only on nikonusa.com, live-checked 2026-09-25. Supersedes the 2026-08-23 citation ($4,999.95, itself never actually applied to this field, which was stuck at $5,899) -- the price appears to have genuinely moved since then, not just a stale-field bug. Regional currencies not independently re-confirmed this pass.', date:'2026-09-25' },
  ...
  'z8': {
    ...
    asin:'B0C4Q71JBY',
    prices:{USD:3599,AUD:5599,EUR:4099,GBP:3199,JPY:561000,CAD:4699,SGD:5199},
    priceSource: { url:'https://www.nikonusa.com/p/z-8/1695/overview', tier:'T1', note:'"Starting at $3,599.95" body-only on nikonusa.com, live-checked 2026-09-25. Supersedes the 2026-08-23 citation ($3,399.95, itself never actually applied to this field, which was stuck at $4,299) -- the price appears to have genuinely moved since then, not just a stale-field bug. Regional currencies not independently re-confirmed this pass.', date:'2026-09-25' },
    sensorMP:45.7, sensorType:'Full-frame Stacked BSI CMOS', processor:'EXPEED 7',
  ...
  'z6-iii': {
    ...
    asin:'B0D77SL8CY',
    prices:{USD:2199,AUD:3399,EUR:2499,GBP:1999,JPY:343000,CAD:2899,SGD:3199},
    priceSource: { url:'https://www.nikonusa.com/p/z6iii/1890/overview', tier:'T1', note:'"Starting at $2,199.95" body-only on nikonusa.com, no sale banner — confirms $2,199 is correct. The prior $2,699 in this field never matched this citation\'s own $2,199 conclusion (an unresolved mismatch from the 2026-08-23 pass); regional currencies are ratio-derived from an earlier refresh and were not independently re-confirmed this pass', date:'2026-09-25' },
  ...
  'z5-ii': {
    ...
    asin:'B0F3HJD64Y',
    prices:{USD:1849,AUD:2499,EUR:1799,GBP:1399,JPY:250000,CAD:2099,SGD:2299},
  ...
  'z7-ii': {
    ...
    imageCredit:{author:"Henry Söderlund from Helsinki, Finland", licence:"CC BY 2.0", licenceUrl:"https://creativecommons.org/licenses/by/2.0", source:"https://commons.wikimedia.org/wiki/File:Nikon_Z_7II_with_Nikkor_Z_24-70mm_F4_S_-_by_Henry_S%C3%B6derlund_(50723434183).jpg"}, asin:'B08L614R6K',
    prices:{USD:2499,AUD:2999,EUR:2199,GBP:1699,JPY:296000,CAD:2499,SGD:2799},
  ...
  'z6-ii': {
    ...
    imageCredit:{author:"Thilo Parg", licence:"CC BY-SA 4.0", licenceUrl:"https://creativecommons.org/licenses/by-sa/4.0", source:"https://commons.wikimedia.org/wiki/File:Nikon_Z_6II_2.jpg"}, asin:'B08L5Z4355',
    prices:{USD:1749,AUD:2199,EUR:1599,GBP:1299,JPY:218000,CAD:1799,SGD:1999},
  ...
  'z5': {
    ...
    imageCredit:{author:"昼落ち", licence:"CC BY-SA 4.0", licenceUrl:"https://creativecommons.org/licenses/by-sa/4.0", source:"https://commons.wikimedia.org/wiki/File:Nikon_Z_5_21_Oct_2020a.jpg"}, asin:'B08DCJNTBX',
    prices:{USD:1449,AUD:1799,EUR:1299,GBP:999,JPY:179000,CAD:1499,SGD:1699},
  ...
  'z30': {
    ...
    prices:{USD:809,AUD:999,EUR:699,GBP:499,JPY:95000,CAD:799,SGD:899},
    sensorMP:20.9, sensorType:'APS-C (DX) CMOS', processor:'EXPEED 6',
  ...
  'zf': {
    ...
    prices:{USD:2199,AUD:3199,EUR:2399,GBP:1799,JPY:320000,CAD:2699,SGD:2999},
    sensorMP:24.5, sensorType:'Full-frame BSI CMOS', processor:'EXPEED 7',
  ...
  'zfc': {
    ...
    prices:{USD:1059,AUD:1499,EUR:1099,GBP:899,JPY:150000,CAD:1199,SGD:1399},
    sensorMP:20.9, sensorType:'APS-C (DX) CMOS', processor:'EXPEED 6',
...
const LENSES = {
  ...
  'z-50mm-f1-8-s': {
    ...
    prices:{USD:669,AUD:699,EUR:null,GBP:null,JPY:null,CAD:599,SGD:null},
  ...
  'z-50mm-f1-2-s': {
    ...
    prices:{USD:2249,AUD:3199,EUR:null,GBP:null,JPY:null,CAD:2699,SGD:null},
    priceIncomplete:true,
  ...
  'z-135mm-f1-8-s-plena': {
    ...
    prices:{USD:2599,AUD:3399,EUR:null,GBP:null,JPY:null,CAD:2899,SGD:null},
    priceIncomplete:true,
  ...
  'z-mc-105mm-f2-8-vr-s': {
    ...
    prices:{USD:1149,AUD:1399,EUR:null,GBP:null,JPY:null,CAD:1199,SGD:null},
    priceIncomplete:true,
  ...
  'z-26mm-f2-8': {
    ...
    prices:{USD:549,AUD:699,EUR:null,GBP:null,JPY:null,CAD:599,SGD:null},
    priceIncomplete:true,
  ...
  'z-35mm-f1-4': {
    ...
    prices:{USD:679,AUD:899,EUR:null,GBP:null,JPY:null,CAD:799,SGD:null},
    priceIncomplete:true,
  ...
  'z-50mm-f1-4': {
    ...
    prices:{USD:599,AUD:899,EUR:null,GBP:null,JPY:null,CAD:699,SGD:null},
    priceIncomplete:true,
  ...
  'z-50mm-f2-8-mc': {
    ...
    prices:{USD:719,AUD:999,EUR:null,GBP:null,JPY:null,CAD:899,SGD:null},
    priceIncomplete:true,
  ...
  'z-dx-24mm-f1-7': {
    ...
    prices:{USD:319,AUD:399,EUR:null,GBP:null,JPY:null,CAD:379,SGD:null},
    priceIncomplete:true,
  ...
  'z-14-24mm-f2-8-s': {
    ...
    prices:{USD:2699,AUD:3099,EUR:null,GBP:null,JPY:null,CAD:2599,SGD:null},
    priceIncomplete:true,
  ...
  'z-14-30mm-f4-s': {
    ...
    prices:{USD:1399,AUD:1699,EUR:null,GBP:null,JPY:null,CAD:1399,SGD:null},
    priceIncomplete:true,
  ...
  'z-24-120mm-f4-s': {
    ...
    prices:{USD:1149,AUD:1599,EUR:null,GBP:null,JPY:null,CAD:1299,SGD:null},
    priceIncomplete:true,
  ...
  'z-100-400mm-f4-5-5-6-vr-s': {
    ...
    prices:{USD:2949,AUD:4199,EUR:null,GBP:null,JPY:null,CAD:3699,SGD:null},
    priceIncomplete:true,
  ...
  'z-24-200mm-f4-6-3-vr': {
    ...
    prices:{USD:949,AUD:1299,EUR:null,GBP:null,JPY:null,CAD:1099,SGD:null},
    priceIncomplete:true,
  ...
  'z-28-400mm-f4-8-vr': {
    ...
    prices:{USD:1449,AUD:1799,EUR:null,GBP:null,JPY:null,CAD:1499,SGD:null},
    priceIncomplete:true,
  ...
  'z-70-180mm-f2-8': {
    ...
    prices:{USD:1399,AUD:1899,EUR:null,GBP:null,JPY:null,CAD:1599,SGD:null},
    priceIncomplete:true,
  ...
  'z-180-600mm-f5-6-6-3-vr': {
    ...
    prices:{USD:2199,AUD:3299,EUR:null,GBP:null,JPY:null,CAD:2699,SGD:null},
    priceIncomplete:true,
  ...
  'z-400mm-f2-8-tc-vr-s': {
    ...
    prices:{USD:14699,AUD:19799,EUR:null,GBP:null,JPY:null,CAD:16499,SGD:null},
    priceIncomplete:true,
  ...
  'z-600mm-f4-tc-vr-s': {
    ...
    prices:{USD:16199,AUD:22899,EUR:null,GBP:null,JPY:null,CAD:19099,SGD:null},
    priceIncomplete:true,
  ...
  'z-dx-12-28mm-pz-vr': {
    ...
    prices:{USD:399,AUD:499,EUR:null,GBP:null,JPY:null,CAD:399,SGD:null},
    priceIncomplete:true,
  ...
  'viltrox-27mm-f12': {
    ...
    imageCredit:{author:"TurnOnTheNight", licence:"CC BY-SA 4.0", licenceUrl:"https://creativecommons.org/licenses/by-sa/4.0", source:"https://commons.wikimedia.org/wiki/File:VILTROX_AF_27mm_F1.2_Pro_20250517112908.jpg"}, asin:'B0CWGMJQC9',
  ...
  'tamron-35-150mm-f2-28': {
    ...
    imageCredit:{author:"Henry Söderlund", licence:"CC BY 2.0", licenceUrl:"https://creativecommons.org/licenses/by/2.0", source:"https://commons.wikimedia.org/wiki/File:Tamron_35-150mm_F2-2.8_Di_III_VXD_(model_A058Z)_Nikon_Z_by_Henry_S%C3%B6derlund.jpg"}, asin:'B0CJGQMDCD',
    specSources: [
  ...
  'tamron-50-400mm-f45-63': {
    ...
    imageCredit:{author:"Henry Söderlund", licence:"CC BY 2.0", licenceUrl:"https://creativecommons.org/licenses/by/2.0", source:"https://commons.wikimedia.org/wiki/File:Tamron_50-400mm_F4.5-6.3_Di_III_VC_VXD,_Nikon_Z_(53995931346).jpg"}, asin:'B0DGW5KNHQ',
    specSources: [
  ...
  'tamron-70-300mm-f45-63': {
    ...
    imageCredit:{author:"Henry Söderlund from Helsinki, Finland", licence:"CC BY 2.0", licenceUrl:"https://creativecommons.org/licenses/by/2.0", source:"https://commons.wikimedia.org/wiki/File:Tamron_70-300mm_F_4.5-6.3_Di_III_RXD_(Model_A047Z)_Nikon_Z_(52393501355).jpg"}, asin:'B0BD9BV8BX',
  ...
  'tamron-150-500mm-f5-67': {
    ...
    imageCredit:{author:"Henry Söderlund", licence:"CC BY 2.0", licenceUrl:"https://creativecommons.org/licenses/by/2.0", source:"https://commons.wikimedia.org/wiki/File:Tamron_150-500mm_F5-6.7_Di_III_VC_VXD_(Model_A057Z)_(53272622666).jpg"}, asin:'B0CM3RVP36',
  ...
  'laowa-10mm-f28-af': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2024/01/VE1028AFFE-13-3-copy-scaled.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-10mm-f-2-8-ff-zero-d/', tier:'T1', note:'official Venus Optics/Laowa store; page states "Auto Focus: Sony FE, Nikon Z"; front 3/4 studio shot, barrel reads "LAOWA 10mm F2.8 CA-Dreamer", mount not visible', date:'2026-09-06' },
    asin:'B0CW9MJW39',
  ...
  'laowa-12mm-f28-lite-zero-d': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2025/06/02_VE1228AFFEk-scaled.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-12mm-f-2-8-lite-zero-d-ff/', tier:'T1', note:'official Venus Optics/Laowa store; page states the lens "supports autofocus for both Sony E and Nikon Z mounts"; front studio shot, barrel reads "LAOWA 12", mount not visible', date:'2026-09-06' },
    asin:'B0GGLJ82Y3',
  ...
  'laowa-8-15mm-f28-fisheye': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2025/06/Untitled-design.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-8-15mm-f-2-8-ff-zoom-fisheye-2/', tier:'T1', note:'official Venus Optics/Laowa store; Mount list "Sony E / Nikon Z / Canon RF / L / GFX / XCD"; front 3/4 studio shot, barrel reads "LAOWA FF II 8-15mm F2.8 FISHEYE ZOOM"', date:'2026-09-06' },
    asin:'B0FKQG1FRX',
    prices:{USD:699,AUD:1099,EUR:799,GBP:599,JPY:108000,CAD:899,SGD:999},
  ...
  'laowa-argus-28mm-f12': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2023/03/2812-E-01-scaled.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-argus-28mm-f-1-2-ff/', tier:'T1', note:'official Venus Optics/Laowa store; "Mounts Available: L mount / Nikon Z / Canon RF / Sony E"; front 3/4 studio shot, barrel reads "LAOWA FF 28mm F1.2 Argus"', date:'2026-09-06' },
    asin:null,
  ...
  'laowa-15mm-f45-macro': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2025/05/Untitled-design.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-15mm-f-4-5-0-5x-wide-angle-macro/', tier:'T1', note:'official Venus Optics/Laowa store; "Auto-Aperture: Sony E, Nikon Z, Canon EF"; front 3/4 studio shot, LAOWA-branded, mount not visible', date:'2026-09-06' },
    asin:'B0F8VR3GGP',
  ...
  'laowa-15mm-f5-cookie': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2024/11/Untitled-design-1.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-15mm-f-5-cookie-ff/', tier:'T1', note:'official Venus Optics/Laowa store; page confirms "Nikon Z (Auto-Aperture)"; top-3/4 studio shot of the pancake, LAOWA-branded', date:'2026-09-06' },
    asin:'B0DQBCMNKB',
  ...
  'laowa-65mm-f28-2x-macro': {
    ...
    imageSource: { url:'https://www.venuslens.net/product/laowa-65mm-f-2-8-2x-ultra-macro-apo/', tier:'T1', note:'official Venus Optics/Laowa store; "Nikon Z and Canon M, RF mount"; front 3/4 studio shot, barrel reads "CF 65mm F2.8 CA-Dreamer Macro 2X"', date:'2026-09-06' },
    asin:null,
  ...
  'laowa-25mm-f28-25-5x-macro': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2018/09/2528_new-scaled.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-25mm-f-2-8-2-5-5x-ultra-macro-2/', tier:'T1', note:'official Venus Optics/Laowa store; page confirms Nikon Z availability; front 3/4 studio shot, barrel reads "25mm F2.8 Ultra Macro 2.5-5.0X"', date:'2026-09-06' },
    asin:'B082BDQSRH',
    prices:{USD:399,AUD:599,EUR:499,GBP:399,JPY:48000,CAD:499,SGD:599},
  ...
  'laowa-100mm-f28-2x-macro': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2019/04/Nikon-scaled.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-100mm-f-2-8-2x-macro-apo/', tier:'T1', note:'official Venus Optics/Laowa store; page confirms Nikon Z availability; front 3/4 studio shot (file named "Nikon"), magnification/aperture scales for the 2x macro APO', date:'2026-09-06' },
    asin:'B0851QKVY4',
  ...
  'laowa-argus-33mm-f095': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2021/05/10mm-f2-01-1-1024x685b.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-argus-33mm-f-0-95-cf-apo/', tier:'T1', note:'official Venus Optics/Laowa store; page confirms Nikon Z availability; front 3/4 studio shot, barrel reads "CF 33mm f/0.95 APO Argus" (maker\'s file name has an unrelated "10mm-f2" typo)', date:'2026-09-06' },
    asin:'B094346SV4',
  ...
  'laowa-17mm-f4-tilt-shift': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2026/02/VE1740FE01-scaled.png',
    imageSource: { url:'https://www.venuslens.net/product/laowa-17mm-f-4-zero-d-tilt-shift-shift/', tier:'T1', note:'official Venus Optics/Laowa store; page lists Nikon Z as an available mount; front studio shot, base reads "LAOWA T/S 17mm F4" with the tilt/shift degree scales', date:'2026-09-06' },
    asin:'B0GYKMB7YJ',
  ...
  'laowa-35mm-f28-tilt-shift-macro': {
    ...
    productUrl:'https://www.venuslens.net/product/the-laowa-35mm-f-2-8-zero-d-tilt-shift-0-5x-macro/',
  },
  ...
  'laowa-100mm-f28-tilt-shift-macro': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2024/12/VE10028TS-FE_002.png',
    imageSource: { url:'https://www.venuslens.net/product/laowa-100mm-f-2-8-tilt-shift-1x-macro/', tier:'T1', note:'official Venus Optics/Laowa store; page lists Nikon Z as an available mount; front studio shot, base reads "LAOWA T/S 100mm F2.8 1X"', date:'2026-09-06' },
    asin:'B0DVMPJM2L',
    prices:{USD:1249,AUD:1899,EUR:1399,GBP:1099,JPY:192000,CAD:1599,SGD:1799},
  ...
  'laowa-15mm-f45-shift': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2020/10/15_1.jpg',
    imageSource: { url:'https://www.venuslens.net/product/15mm-f-4-5-zero-d-shift/', tier:'T1', note:'official Venus Optics/Laowa store; page lists Nikon Z as an available mount; front 3/4 studio shot, bulbous front element, aperture ring tops out at f/4.5, shift degree scale', date:'2026-09-06' },
    asin:'B08NPXCZRQ',
    prices:{USD:1199,AUD:1899,EUR:1399,GBP:1099,JPY:144000,CAD:1599,SGD:1699},
    productUrl:'https://www.venuslens.net/product/15mm-f-4-5-zero-d-shift/',
  },
  ...
  'laowa-12-24mm-f56-shift': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2024/11/02_VE1224S-NZ-scaled.png',
    imageSource: { url:'https://www.venuslens.net/product/laowa-12-24mm-f-5-6-zoom-shift-cf/', tier:'T1', note:'official Venus Optics/Laowa store; front 3/4 studio shot, file explicitly named "VE1224S-NZ" (Nikon Z); barrel reads "CF 12-24mm F5.6 Zoom Shift"', date:'2026-09-06' },
    asin:'B0B6GYWRM1',
  ...
  'laowa-85mm-f56-2x-macro': {
    ...
    imageUrl:'https://www.venuslens.net/wp-content/uploads/2021/11/main-01.jpg',
    imageSource: { url:'https://www.venuslens.net/product/laowa-85mm-f-5-6-2x-ultra-macro-apo/', tier:'T1', note:'official Venus Optics/Laowa store; page confirms Nikon Z availability; front 3/4 studio shot, aperture ring tops out at f/5.6, 2:1 magnification scale', date:'2026-09-06' },
    asin:'B09NMCYCD2',
  ...
  'samyang-14mm-f28': {
    ...
    imageUrl:'https://samyangus.com/cdn/shop/products/MF14_2.8Z_Front.jpg',
    imageSource: { url:'https://samyangus.com/products/14mm-f2-8-full-frame-ultra-wide-angle-nikon-z', tier:'T1', note:'official Samyang US store, dedicated Nikon Z product page (SKU SYZ14-N); front product shot, file named "MF14_2.8Z_Front"', date:'2026-09-06' },
    asin:'B07QRVHBXS',
  ...
  'samyang-85mm-f14': {
    ...
    imageUrl:'https://samyangus.com/cdn/shop/products/MF85_1.4Z_Front.jpg',
    imageSource: { url:'https://samyangus.com/products/85mm-f1-4-full-frame-telephoto-nikon-z', tier:'T1', note:'official Samyang US store, dedicated Nikon Z product page; barrel explicitly reads "MF 85/1.4 Z"', date:'2026-09-06' },
    asin:'B07QRVFD3Q',
  ...
  'ttartisan-17mm-f18-air': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/af-17mm-f1-8-air', tier:'T1', note:'official TTArtisan store; spec table: focal 17mm, F1.8-F16, APS-C, 6 blades, 52mm filter, 0.18m MFD, 14E/10G, 81° AoV, weight "Around 161~178g" (color-variant range, stored as 170g midpoint); mount selector lists Sony E/Fuji X/Nikon Z; Z-mount dims from the page\'s own Size diagram image (X 47×60mm, E 47×60mm, Z 51×65mm)', date:'2026-08-31' },
    ],
    asin:'B0GVSMN7HG',
    ...
    imageUrl:'https://ttartisan.store/cdn/shop/files/SKU-E_dc4080f7-361e-43f0-9a8c-ed8e4e03675e.jpg',
    imageSource: { url:'https://ttartisan.store/products/af-17mm-f1-8-air', tier:'T1', note:'official TTArtisan store product photo; the page\'s og:image reflects the default Sony E variant (filename "SKU-E_...") rather than the Z-selected one — the theme does not update the OG tag on a client-side mount-selector click. Same lens barrel is cosmetically identical across mounts in a front-on shot (confirmed against the Size-diagram screenshots, which differ only at the rear flange)', date:'2026-08-31' },
  },
  ...
  'ttartisan-23mm-f18': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/ttartisan-af-23mm-f1-8', tier:'T1', note:'official TTArtisan store; spec table: focal 23mm, F1.8-F16, APS-C, 9 blades, 52mm filter, 0.3m MFD, 11E/9G, 62° AoV, weight 210g (single figure, no color-variant range unlike most of this batch); mount selector lists Fuji X/Sony E/Nikon Z; Z-mount dims from the page\'s own Size diagram image (X 60×67mm, E 60×67mm, Z 62×64mm). `year` estimated from the earliest visible customer review date (2025-11-21) — no explicit launch date published', date:'2026-08-31' },
    ],
    asin:'B0FX2JM44Q',
    prices:{USD:127,AUD:199,EUR:99,GBP:99,JPY:20000,CAD:199,SGD:199},
    ...
    imageSource: { url:'https://ttartisan.store/products/ttartisan-af-23mm-f1-8', tier:'T1', note:'official TTArtisan store product photo (og:image); a verified-purchase review on this exact page explicitly confirms Nikon-camera use', date:'2026-08-31' },
  },
  ...
  'ttartisan-35mm-f18-ii': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2024, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/ttartisan-af-35mm-f1-8', tier:'T1', note:'official TTArtisan store, page titled "AF 35mm F1.8 II"; spec table: focal 35mm, F1.8-F16, APS-C, 9 blades, 52mm filter, 0.4m MFD, 10E/7G, 45° AoV, weight "Around 176~193g" (Black/Silver/Orange color-variant range, stored as 185g midpoint); mount selector lists Fuji X/Sony E/Nikon Z; Z-mount dims from the page\'s own Size diagram image, cross-checked identical across two color renders (X 49×65mm, E 49×65mm, Z 51×66mm). A customer review dated 2026-07-20 explicitly names "Z mount". The Mark II supersedes an older, now sold-out original "35mm F1.8" (not entered — see PROGRESS.md deferred list)', date:'2026-08-31' },
    ],
    asin:'B0DRV2DCSL',
    prices:{USD:125,AUD:199,EUR:99,GBP:99,JPY:19000,CAD:199,SGD:199},
    productUrl:'https://ttartisan.store/products/ttartisan-af-35mm-f1-8',
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_9e55fda4-0d75-4253-8ca7-0e669462dffd.jpg',
    imageSource: { url:'https://ttartisan.store/products/ttartisan-af-35mm-f1-8', tier:'T1', note:'official TTArtisan store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  'ttartisan-40mm-f2': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2024, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/af-40mm-f2', tier:'T1', note:'official TTArtisan store; spec table: focal 40mm, F2-F16, Full Frame, 7 blades, 52mm filter, 0.4m MFD, 9E/6G, 57° AoV, weight "Around166~176g" (stored as 171g midpoint); mount selector lists Sony E/Nikon Z/L mount (no Fuji X — full-frame-only design); Z-mount dims from the page\'s own Size diagram image (E 44×61mm, Z 46×65mm, L 43×63mm — Z is both the longest and widest of the three). Clicked aperture ring, unusual for this maker\'s AF line', date:'2026-08-31' },
    ],
    asin:'B0FJM1JBJK',
    prices:{USD:168,AUD:299,EUR:199,GBP:199,JPY:25000,CAD:199,SGD:199},
    productUrl:'https://ttartisan.store/products/af-40mm-f2',
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_d786fd18-b4ed-4e54-92e1-02b826987ef0.jpg',
    imageSource: { url:'https://ttartisan.store/products/af-40mm-f2', tier:'T1', note:'official TTArtisan store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  'ttartisan-50mm-f18-neo': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/ttartisan-af-50mm-f1-8-neo', tier:'T1', note:'official TTArtisan store; "Neo" line — simplified design with no focus/aperture rings, glass-fiber composite body. Spec table: focal 50mm, F1.8-F16, Full-frame, 7 blades, 52mm filter, 0.48m MFD, 12E/8G, 45° AoV, weight "Around 156~167g" (stored as 162g midpoint); mount selector lists Sony E/Nikon Z/L mount; Z-mount dims from the page\'s own Size diagram image (E 51.5×61mm, Z 54×66mm, L 50×64mm). A customer review explicitly names "Nikon Zf"', date:'2026-08-31' },
    ],
    asin:'B0H4G16VTV',
    prices:{USD:89,AUD:99,EUR:99,GBP:99,JPY:14000,CAD:99,SGD:99},
    productUrl:'https://ttartisan.store/products/ttartisan-af-50mm-f1-8-neo',
    imageUrl:'https://ttartisan.store/cdn/shop/files/SKU-E_15b3b488-3a04-4359-85aa-913a9c735cfb.jpg',
    imageSource: { url:'https://ttartisan.store/products/ttartisan-af-50mm-f1-8-neo', tier:'T1', note:'official TTArtisan store product photo; the page\'s og:image reflects the default Sony E variant (filename "SKU-E_...") rather than the Z-selected one — the theme does not update the OG tag on a client-side mount-selector click. Cosmetically identical across mounts in a front-on shot', date:'2026-08-31' },
  },
  ...
  'ttartisan-56mm-f18': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2023, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/56mm', tier:'T1', note:'official TTArtisan store, page titled "AF 56mm F1.8"; spec table: focal 56mm, F1.8-F16, APS-C, 9 blades, 52mm filter, 0.5m MFD, 10E/9G, 28° AoV, weight "Around 233~245g" (Black/Silver, stored as 239g midpoint); mount selector lists Fuji X/Sony E/Nikon Z; Z-mount dims from the page\'s own Size diagram image (E 66×65mm, X 62×65mm, Z 70×65mm)', date:'2026-08-31' },
    ],
    asin:'B0D37CBZV1',
    prices:{USD:158,AUD:199,EUR:199,GBP:99,JPY:23000,CAD:199,SGD:199},
    productUrl:'https://ttartisan.store/products/56mm',
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_a9032302-fd97-45f6-aa5b-208375f3a45d.jpg',
    imageSource: { url:'https://ttartisan.store/products/56mm', tier:'T1', note:'official TTArtisan store product photo (og:image). Current sale price is $129 (a discount, not a new RRP) — regular price $158 used as USD list', date:'2026-08-31' },
  },
  ...
  'ttartisan-75mm-f2': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2023, discontinued:false,
    specSources: [
      { url:'https://ttartisan.store/products/ttartisan-af-75mm-f2', tier:'T1', note:'official TTArtisan store; spec table: focal 75mm, F2-F16, Full-Frame, 9 blades, 62mm filter, 0.75m MFD, 10E/7G, 32° AoV, weight "Around 326-340g" (Black/Silver, stored as 333g midpoint); mount selector lists Sony E/Fuji X/Nikon Z/L mount; Z-mount dims from the page\'s own Size diagram image (E 74×67mm, L 76×67mm, X 74×67mm, Z 76×67mm — Z ties L for the longest). This was one of round-1\'s originally flagged candidate leads ("75/2"), confirmed real and entered this round', date:'2026-08-31' },
    ],
    asin:'B0DH2GN4NT',
    prices:{USD:199,AUD:299,EUR:199,GBP:199,JPY:29000,CAD:299,SGD:299},
    productUrl:'https://ttartisan.store/products/ttartisan-af-75mm-f2',
    imageUrl:'https://ttartisan.store/cdn/shop/files/1_03076011-c664-40e3-962a-377db23cc259.jpg',
    imageSource: { url:'https://ttartisan.store/products/ttartisan-af-75mm-f2', tier:'T1', note:'official TTArtisan store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  '7artisans-10mm-f28': {
    ...
    weatherSealed:false, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-10mm-f2-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'official 7Artisans store "Autofocus Z" collection listing, $199, confirms Nikon Z as a purchasable mount option — page itself carries no spec table (prose + mount/color selector only)', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-10mm-f28-lens.html', tier:'T2', note:'Thom Hogan\'s Nikon-Z-specific third-party lens tracker; full spec table: APS-C (DX), 105.3° AoV, 11 elements/10 groups (2 aspherical/3 ED/2 high-refractive), 7-blade diaphragm, 62mm filter, 0.3m MFD, 72×69mm, 232g (8.2oz), $199, announced November 2025. No dust/splash-resistance claim on this lens (unlike every other 7Artisans lens in this batch)', date:'2026-08-31' },
    ],
    asin:'B0FVF5DL3T',
    prices:{USD:199,AUD:299,EUR:199,GBP:199,JPY:31000,CAD:299,SGD:299},
    productUrl:'https://7artisans.store/products/af-10mm-f2-8-aps-c-lens-for-e-fx-z',
    imageUrl:'https://7artisans.store/cdn/shop/files/1_b97a4138-6403-4c57-9fa4-10149af13b7e.jpg',
    imageSource: { url:'https://7artisans.store/products/af-10mm-f2-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'official 7Artisans store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  '7artisans-25mm-f18-lite': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2026, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'official 7Artisans store — one shared Shopify listing ("AF 25/35/50mm F1.8 APS-C") with a focal-length variant selector covering all three "Lite" primes, "From $125.00", confirms E/Fuji-X/Nikon-Z mount availability. No spec table on the page itself', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-25mm-f18-lite.html', tier:'T2', note:'full spec table: crop sensor (DX), 58.3° AoV, 8 elements/5 groups (5 high-refractive), 9-blade diaphragm, 58mm filter, 0.25m MFD, 51×67mm, 183g (6.5oz), dust/splash-resistant design, $125, announced 2026-06-16', date:'2026-08-31' },
    ],
    asin:'B0H44GGCHD',
    prices:{USD:125,AUD:199,EUR:99,GBP:99,JPY:20000,CAD:199,SGD:199},
    productUrl:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z',
    imageUrl:'https://7artisans.store/cdn/shop/files/2342434.jpg',
    imageSource: { url:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'official 7Artisans store product photo (og:image) — shared listing photo for the 25/35/50mm F1.8 Lite trio, used for all three entries', date:'2026-08-31' },
  },
  ...
  '7artisans-35mm-f18-lite': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2026, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'same shared "AF 25/35/50mm F1.8 APS-C" listing as the 25mm/50mm Lite siblings, "From $125.00", confirms E/Fuji-X/Nikon-Z mount availability', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-35mm-f18-lite.html', tier:'T2', note:'full spec table: crop sensor (DX), 44° AoV, 7 elements/6 groups (5 high-refractive), 9-blade diaphragm, 58mm filter, 0.35m MFD, 51×67mm, 181g (6.5oz), dust/splash-resistant design, $125, announced 2026-06-16', date:'2026-08-31' },
    ],
    asin:'B0H441NGGP',
    prices:{USD:125,AUD:199,EUR:99,GBP:99,JPY:20000,CAD:199,SGD:199},
    productUrl:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z',
  ...
  '7artisans-50mm-f18-lite': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2026, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'same shared "AF 25/35/50mm F1.8 APS-C" listing as the 25mm/35mm Lite siblings, "From $125.00", confirms E/Fuji-X/Nikon-Z mount availability', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-50mm-f18-lite.html', tier:'T2', note:'full spec table: crop sensor (DX), 31.4° AoV, 6 elements/5 groups (3 high-refractive), 9-blade diaphragm, 58mm filter, 0.55m MFD, 51×67mm, 178g (6.5oz), dust/splash-resistant design, $125, announced 2026-06-16', date:'2026-08-31' },
    ],
    asin:'B0H44PNNBK',
    prices:{USD:125,AUD:199,EUR:99,GBP:99,JPY:20000,CAD:199,SGD:199},
    productUrl:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z',
    imageUrl:'https://7artisans.store/cdn/shop/files/2342434.jpg',
    imageSource: { url:'https://7artisans.store/products/af-25-35-50mm-f1-8-aps-c-lens-for-e-fx-z', tier:'T1', note:'official 7Artisans store product photo (og:image) — shared listing photo for the 25/35/50mm F1.8 Lite trio, used for all three entries. Distinct from the existing full-frame `7artisans-50mm-f18` entered below', date:'2026-08-31' },
  },
  ...
  '7artisans-35mm-f18': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-35mm-f1-8-full-frame-lens-for-e-z-l', tier:'T1', note:'official 7Artisans store, "AF 35mm F1.8 Full-frame Lens for E/Z/L", $299, confirms Nikon Z mount option', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-35mm-f18-lens.html', tier:'T2', note:'full spec table: full frame (FX), 11 elements/8 groups (2 aspherical/2 high-refractive/1 ED), 11-blade diaphragm, 62mm filter, 0.4m MFD, AF/MF switch + Fn button, 94×72mm, 426g (15oz), dust/splash-resistant design, $299, announced 2025-10-15', date:'2026-08-31' },
    ],
    asin:'B0FLDDY167',
    prices:{USD:299,AUD:499,EUR:299,GBP:299,JPY:46000,CAD:399,SGD:399},
    productUrl:'https://7artisans.store/products/af-35mm-f1-8-full-frame-lens-for-e-z-l',
    imageUrl:'https://7artisans.store/cdn/shop/files/1111_090f390e-b3f4-4eba-ae1a-49a0c210d2d6.jpg',
    imageSource: { url:'https://7artisans.store/products/af-35mm-f1-8-full-frame-lens-for-e-z-l', tier:'T1', note:'official 7Artisans store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  '7artisans-40mm-f25-lite': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2026, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-40mm-f2-5-full-frame-lens-for-e-z-l', tier:'T1', note:'official 7Artisans store, "AF 40mm F2.5 Full-frame Lens for E/Z/L", $159, confirms Nikon Z mount option. Genuinely new — announced 2026-08-06, 25 days before this entry, within the skill\'s ≤1-month new-release allowance (though every non-nullable field is already sourced, so nothing is left null)', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-40mm-f25-lite.html', tier:'T2', note:'full spec table: full frame (FX) pancake, 56.1° AoV, 7 elements/6 groups (1 aspherical/3 high-refractive), 9-blade diaphragm, clicked aperture ring (unusual — most of this batch is declicked), box-style hood, AF/MF switch + Fn button, 46mm filter, 0.4m MFD, 40×63mm, 90g (3.2oz), dust/splash-resistant design, $159, announced 2026-08-06', date:'2026-08-31' },
    ],
    asin:'B0H6P846N9',
    prices:{USD:159,AUD:199,EUR:199,GBP:99,JPY:25000,CAD:199,SGD:199},
    productUrl:'https://7artisans.store/products/af-40mm-f2-5-full-frame-lens-for-e-z-l',
    imageUrl:'https://7artisans.store/cdn/shop/files/E_2ae73775-1b42-4d6d-883d-7040225b69f2.jpg',
    imageSource: { url:'https://7artisans.store/products/af-40mm-f2-5-full-frame-lens-for-e-z-l', tier:'T1', note:'official 7Artisans store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  '7artisans-50mm-f18': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2025, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/50mm-f1-8-af-lens', tier:'T1', note:'official 7Artisans store, "AF 50mm F1.8 Full-frame Lens for Z/E", $228, confirms Nikon Z mount option', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/50mm-f18-lens-specification.html', tier:'T2', note:'full spec table: full frame (FX), 11 elements/9 groups, 11-blade diaphragm, 62mm filter, 0.5m MFD, 100×72mm, 420g (14.8oz), dust/splash-resistant design, $230 (T1\'s $228 kept, small rounding gap)', date:'2026-08-31' },
    ],
    asin:'B0CZHPVD6S',
    prices:{USD:228,AUD:399,EUR:299,GBP:199,JPY:35000,CAD:299,SGD:299},
    productUrl:'https://7artisans.store/products/50mm-f1-8-af-lens',
    imageUrl:'https://7artisans.store/cdn/shop/files/16002_febadaf8-f451-414f-af5b-bad1e1789e09.jpg',
    imageSource: { url:'https://7artisans.store/products/50mm-f1-8-af-lens', tier:'T1', note:'official 7Artisans store product photo (og:image). Distinct from the existing `7artisans-50mm-f18-lite` (APS-C variant) entered above', date:'2026-08-31' },
  },
  ...
  '7artisans-85mm-f18': {
    ...
    weatherSealed:true, ois:false, oisStops:null, year:2024, discontinued:false,
    specSources: [
      { url:'https://7artisans.store/products/af-85mm-f1-8-full-frame-lens-for-z', tier:'T1', note:'official 7Artisans store, "AF 85mm F1.8 Full-frame Lens for Z" (a separate `-for-l` listing exists for L-mount, not this one), $299, confirms Nikon Z mount', date:'2026-08-31' },
      { url:'https://www.zsystemuser.com/z-mount-lenses/third-party-lenses/third-party-autofocus-lense/7artisans-autofocus-lenses/7artisans-85mm-f18-lens.html', tier:'T2', note:'full spec table: full frame (FX), 28.5° AoV, 10 elements/7 groups (2 ED/2 high-refractive), 11-blade diaphragm, 62mm filter, 0.8m MFD, 100×72mm, 452g (16oz), dust/splash-resistant design, $300 (T1\'s $299 kept), announced 2024-10-17', date:'2026-08-31' },
    ],
    asin:'B0D9B8JMLB',
    prices:{USD:299,AUD:499,EUR:299,GBP:299,JPY:45000,CAD:399,SGD:399},
    productUrl:'https://7artisans.store/products/af-85mm-f1-8-full-frame-lens-for-z',
    imageUrl:'https://7artisans.store/cdn/shop/files/6a0f48436f03bf48e8c7f28f9f150b4c_c346e238-3669-476d-83fe-548e5ba50c61.jpg',
    imageSource: { url:'https://7artisans.store/products/af-85mm-f1-8-full-frame-lens-for-z', tier:'T1', note:'official 7Artisans store product photo (og:image)', date:'2026-08-31' },
  },
  ...
  'yongnuo-11mm-f18': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2025/10/YN11mmF18ZDADSMWL_1.jpg',
    imageSource: { url:'https://yongnuo.eu/yn-11mm-f-1-8-lens-for-nikon-aps-c/', tier:'T1', note:'official Yongnuo EU store, filed under the maker\'s Nikon Z/F lens listing; studio product shot carries a "Z mount" / "APS-C" / "Auto Focus" badge overlay and the file is named "YN11mmF18ZDADSMWL"', date:'2026-09-06' },
    asin:'B0GC4M3MPR',
  ...
  'yongnuo-23mm-f14': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2025/10/YN23mmF1.4Nikon_1.jpg',
    imageSource: { url:'https://yongnuo.eu/yn-23mm-f-1-4-aps-c/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; file named "YN23mmF1.4Nikon", shot carries a "Z mount" badge overlay', date:'2026-09-06' },
    asin:'B0DFM49DJ1',
  ...
  'yongnuo-33mm-f14': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2025/03/YN_33mm_f1.4_APS-C_a.jpg',
    imageSource: { url:'https://yongnuo.eu/lenses/nikon-z-f/yongnuo-33mm-f-1-4-aps-c-lens-for-nikon/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; barrel reads "33", caption "33mm f/1.4"; shared studio image (badge overlay "E/Z/X/R mount"), mount bayonet not distinctly visible', date:'2026-09-06' },
    asin:'B0DJVRKGV7',
  ...
  'yongnuo-35mm-f18': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2024/10/YN_35mm_f1.8_APS-C_1.jpg',
    imageSource: { url:'https://yongnuo.eu/lenses/nikon-z-f/yongnuo-35mm-f-1-8-aps-c-lens-for-nikon-z-mount-camera-auto-focus-large-aperture-remote-control/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; shot carries a "Z mount" / "APS-C" / "Auto Focus" badge overlay', date:'2026-09-06' },
    asin:'B0F66GW8Q8',
    prices:{USD:300,AUD:499,EUR:299,GBP:299,JPY:42000,CAD:399,SGD:399},
  ...
  'yongnuo-50mm-f18-da': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2024/03/YN50mm_F1.8Z_DA_DSM_lens_1.jpg',
    imageSource: { url:'https://yongnuo.eu/lenses/nikon-z-f/yn50mm-f1-8z-da-dsm/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; barrel explicitly reads "YN50mm F1.8Z DA DSM"', date:'2026-09-06' },
    asin:'B0CTJGD52V',
  ...
  'yongnuo-56mm-f14': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2025/03/YN_56mm_f1.4_APS_C_a.jpg',
    imageSource: { url:'https://yongnuo.eu/lenses/nikon-z-f/yongnuo-56mm-f-1-4-aps-c/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; barrel reads "YN56mm ... DA DSM WL", caption "56mm f/1.4"; shared studio image (badge overlay "E/Z/X/R mount")', date:'2026-09-06' },
    asin:null,
  ...
  'yongnuo-85mm-f18': {
    ...
    imageUrl:'https://yongnuo.eu/wp-content/uploads/2024/03/YN85mm_F1.8Z_DF_DSM_lens_1.jpg',
    imageSource: { url:'https://yongnuo.eu/lenses/nikon-z-f/yn85mm-f1-8z-df-dsm/', tier:'T1', note:'official Yongnuo EU store, Nikon Z/F lens listing; barrel reads "YN85mm F1.8Z DF DSM", the file\'s own EXIF description reads "YN85mm F1.8Z DF DSM Portrait Lens For Nikon Z Mount Camera"', date:'2026-09-06' },
    asin:'B09VPCWQCH',
  ...
  'meike-24mm-f14': {
    ...
    imageUrl:'https://meikeglobal.com/cdn/shop/files/2414-_1.jpg',
    imageSource: { url:'https://meikeglobal.com/products/2414z', tier:'T1', note:'official Meike Global store, "24mm f1.4 MIX ... for Z Cameras" product page; barrel reads "24/1.4" with "MIX" branding; shared studio image, mount bayonet not distinctly visible', date:'2026-09-06' },
    asin:'B0FMDJYX5Z',
  ...
  'meike-35mm-f18-pro': {
    ...
    imageUrl:'https://meikeglobal.com/cdn/shop/files/3518-pro--_1.jpg',
    imageSource: { url:'https://meikeglobal.com/products/3518proz', tier:'T1', note:'official Meike Global store, "35mm f1.8 Pro ... for Z Cameras" product page; barrel reads "MEIKE 35/1.8" with a "Pro" switch badge; shared studio image, mount bayonet not distinctly visible', date:'2026-09-06' },
    asin:'B0FFSZTV4N',
  ...
  'meike-50mm-f18': {
    ...
    imageUrl:'https://meikeglobal.com/cdn/shop/files/10_8dea6e7c-7e7a-4f13-8665-de58f26e4c47.jpg',
    imageSource: { url:'https://meikeglobal.com/products/5018z', tier:'T1', note:'official Meike Global store, "50mm F1.8 ... for Z Cameras" product page; front ring reads "50mm 1:1.8 AUTO FOCUS LENS 0.63m o58mm", side reads "MEIKE 50/1.8"; shared studio image, mount bayonet not distinctly visible', date:'2026-09-06' },
    asin:'B0D9XY9Z71',
  ...
  'meike-85mm-f18-pro': {
    ...
    imageUrl:'https://meikeglobal.com/cdn/shop/files/8518-pro-E-1.jpg',
    imageSource: { url:'https://meikeglobal.com/products/8518proz', tier:'T1', note:'official Meike Global store, "85mm f1.8 Pro ... for Z Cameras" product page; barrel reads "MEIKE 85/1.8" with a "Pro" badge; shared studio image (Meike reuses one photoset across E/Z/L listings), mount bayonet not distinctly visible', date:'2026-09-06' },
    asin:'B0FX8FSZ33',
...
const LENS_DROPDOWN_GROUPS = [
  ...
  { label: '── Other ──', ids: ['yongnuo-11mm-f18', 'yongnuo-23mm-f14', 'yongnuo-33mm-f14', 'yongnuo-35mm-f18', 'yongnuo-35mm-f2', 'yongnuo-50mm-f18-da', 'yongnuo-50mm-f18', 'yongnuo-56mm-f14', 'yongnuo-85mm-f18', 'ttartisan-27mm-f28', 'ttartisan-17mm-f18-air', 'ttartisan-23mm-f18', 'ttartisan-35mm-f18-ii', 'ttartisan-40mm-f2', 'ttartisan-50mm-f18-neo', 'ttartisan-56mm-f18', 'ttartisan-75mm-f2', 'ttartisan-85mm-f18-neo', '7artisans-27mm-f28', '7artisans-10mm-f28', '7artisans-25mm-f18-lite', '7artisans-35mm-f18-lite', '7artisans-50mm-f18-lite', '7artisans-35mm-f18', '7artisans-40mm-f25-lite', '7artisans-50mm-f18', '7artisans-85mm-f18', 'meike-24mm-f14', 'meike-35mm-f18-pro', 'meike-50mm-f18', 'meike-85mm-f18', 'meike-85mm-f18-pro', 'meike-85mm-f18-se-ii'] },
];
