...
const BRAND_CONFIG = {
  ...
  cameras: {
    ...
    heroSubtitle: 'Compare up to 4 cameras side-by-side across all generations',
...
const LENSES = {
  ...
  'xf-27mm-f28-orig': {
    name:'XF 27mm f/2.8', manufacturer:'Fujifilm', line:'XF', type:'Prime',
    mount:'x', focalLength:27, focalLengthMin:null, focalLengthMax:null, focalLengthEquiv:'41mm',
    maxAperture:2.8, minAperture:16, weight:78, length:23, diameter:61.2,
    filterThread:39, minFocusDist:34, maxMagnification:0.1,
    elements:7, groups:5, blades:7, afType:'Micromotor',
    weatherSealed:false, ois:false, oisStops:null, year:2013, discontinued:true,
    imageUrl:'https://fujifilm-x.b-cdn.net/wp-content/uploads/2016/10/6_thum_xf27mm2-8.jpg',
    imageSource: { url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf27mmf28/', tier:'T1', note:'official Fujifilm discontinued-lenses page product photo', date:'2026-09-25' },
    asin:null,
    prices:{USD:449,AUD:null,EUR:null,GBP:null,JPY:null,CAD:null,SGD:null},
    specSources: [{ url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf27mmf28/', tier:'T1', note:'official spec table: 7 elements/5 groups (1 aspherical), min aperture F16, 7 rounded blades, MFD 0.34m macro range, max mag 0.1x, ø61.2mm x 23mm, 78g', date:'2026-09-25' }],
    priceSource: { url:'https://www.dpreview.com/products/fujifilm/lenses/fujifilm_xf_27mm/', tier:'T2', note:'announced 2013-06-24 (originally released alongside the X-M1) at a suggested retail price of ~$449; superseded 2021 by the R WR redesign (real optical-formula change: 7/5 vs 8/7 elements/groups, plus added aperture ring + weather sealing), so kept as its own coexisting discontinued entry rather than merged into xf-27mm-f28. USD-only per discontinued-item convention.', date:'2026-09-25' },
    productUrl:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf27mmf28/',
  },
  'xf-30mm-f28-macro': {
  ...
  'xf-56mm-f12-r': {
    name:'XF 56mm f/1.2 R', manufacturer:'Fujifilm', line:'XF', type:'Prime',
    mount:'x', focalLength:56, focalLengthMin:null, focalLengthMax:null, focalLengthEquiv:'85mm',
    maxAperture:1.2, minAperture:16, weight:405, length:69.7, diameter:73.2,
    filterThread:62, minFocusDist:70, maxMagnification:0.09,
    elements:11, groups:8, blades:7, afType:'Micromotor',
    weatherSealed:false, ois:false, oisStops:null, year:2014, discontinued:true,
    imageUrl:'https://fujifilm-x.b-cdn.net/wp-content/uploads/2016/10/10_thum_xf56mmf1-2.jpg',
    imageSource: { url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r/', tier:'T1', note:'official Fujifilm discontinued-lenses page product photo', date:'2026-09-25' },
    asin:null,
    prices:{USD:999,AUD:null,EUR:null,GBP:null,JPY:null,CAD:null,SGD:null},
    specSources: [{ url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r/', tier:'T1', note:'official spec table: 11 elements/8 groups (1 aspherical, 2 ED), min aperture F16, 7 rounded blades, MFD 0.7m, max mag 0.09x, ø73.2mm x 69.7mm, 405g', date:'2026-09-25' }],
    priceSource: { url:'https://www.dpreview.com/articles/8705998726/fujifilm-unveils-xf-56mm-f1-2-r-portrait-lens-for-x-system', tier:'T1', note:'announced 2014-01-06 at a suggested retail price of $999.99; superseded 2022 by the R WR redesign (genuinely different optical formula: 13/11 vs 11/8 elements/groups), so kept as its own coexisting discontinued entry. USD-only per discontinued-item convention.', date:'2026-09-25' },
    productUrl:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r/',
  },
  'xf-56mm-f12-r-apd': {
    name:'XF 56mm f/1.2 R APD', manufacturer:'Fujifilm', line:'XF', type:'Prime',
    mount:'x', focalLength:56, focalLengthMin:null, focalLengthMax:null, focalLengthEquiv:'85mm',
    maxAperture:1.2, minAperture:16, weight:405, length:69.7, diameter:73.2,
    filterThread:62, minFocusDist:70, maxMagnification:0.09,
    elements:11, groups:8, blades:7, afType:'Micromotor',
    weatherSealed:false, ois:false, oisStops:null, year:2014, discontinued:true,
    imageUrl:'https://fujifilm-x.b-cdn.net/wp-content/uploads/2016/10/11_thum_xfmm56f1-2-r-apd.jpg',
    imageSource: { url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r-apd/', tier:'T1', note:'official Fujifilm discontinued-lenses page product photo', date:'2026-09-25' },
    asin:null,
    prices:{USD:1499,AUD:null,EUR:null,GBP:null,JPY:null,CAD:null,SGD:null},
    specSources: [{ url:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r-apd/', tier:'T1', note:'official spec table: 11 elements/8 groups (adds an internal apodization filter for smoother bokeh, otherwise same formula as the R), min aperture F16, 7 rounded blades, MFD 0.7m, max mag 0.09x, ø73.2mm x 69.7mm, 405g', date:'2026-09-25' }],
    priceSource: { url:'https://www.dpreview.com/products/fujifilm/lenses/fujifilm_xf_56mm_apd/', tier:'T2', note:'announced 2014-09-10, roughly $500 above the standard R\'s $999.99 per contemporary coverage — $1,499. A genuinely distinct SKU (apodization filter changes rendering, not just cosmetic), sold alongside the plain R until both were discontinued by the 2022 R WR. USD-only per discontinued-item convention.', date:'2026-09-25' },
    productUrl:'https://www.fujifilm-x.com/global/products/discontinued-lenses/xf56mmf12-r-apd/',
  },
  'xf-60mm-f24-macro': {
  ...
  'xc-16-50mm-f35-56': {
    ...
    maxAperture:3.5, minAperture:22, weight:195, length:65.2, diameter:62.6,
    filterThread:58, minFocusDist:30, maxMagnification:0.15,
    elements:12, groups:10, blades:7, afType:'Stepping Motor',
    weatherSealed:false, ois:true, oisStops:3.5, year:2015, discontinued:true,
    ...
    specSources: [{ url:'https://www.fujifilm-x.com/en-us/products/discontinued-lenses/xc16-50mmf35-56-ois-2/', tier:'T1', note:'listed on Fujifilm\'s own discontinued-lenses page. Fix 2026-09-25: year was 2012 (predates even the original OIS\'s June 2013 announcement) -- corrected to 2015, the OIS II\'s real announced date (2015-01-15). Also length/diameter were transposed (62.6/65 -> 65.2/62.6), confirmed against dpreview\'s independent spec table.', date:'2026-08-15' }],
...
const LENS_DROPDOWN_GROUPS = [
  ...
  { label: '── Fujifilm XF Primes ──',  ids: ['xf-8mm-f35','xf-14mm-f28','xf-16mm-f14','xf-16mm-f28','xf-18mm-f14','xf-18mm-f2','xf-23mm-f14-lm-wr','xf-23mm-f2','xf-23mm-f28','xf-27mm-f28','xf-27mm-f28-orig','xf-30mm-f28-macro','xf-33mm-f14','xf-35mm-f14','xf-35mm-f2','xf-50mm-f10','xf-50mm-f2','xf-56mm-f12-wr','xf-56mm-f12-r','xf-56mm-f12-r-apd','xf-60mm-f24-macro','xf-80mm-f28-macro','xf-90mm-f2','xf-200mm-f2','xf-400mm-f45','xf-500mm-f56'] },
